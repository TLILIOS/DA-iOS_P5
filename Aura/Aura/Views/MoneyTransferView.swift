...
struct MoneyTransferView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            // Message
            if let transferMessage = viewModel.transferMessage {
...
#Preview {
    MoneyTransferView(viewModel: MoneyTransferViewModel(networkService: NetworkService(token: ""), amount: 973, recipient: "Me@gmail.com"))
}
